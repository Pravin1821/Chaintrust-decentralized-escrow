        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <section className="p-4 bg-gray-900/70 border border-gray-800/60 rounded-xl lg:col-span-2">
            ...
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-full bg-gray-800 border border-gray-700/60 flex items-center justify-center text-sm font-bold">
              ...
              <div className="flex-1">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <span
                    className={`px-2 py-0.5 text-xs rounded-full border ${user.isActive ? "bg-emerald-500/20 text-emerald-300 border-emerald-500/30" : "bg-red-500/20 text-red-300 border-red-500/30"}`}
                  >
          ...
          <section className="p-4 bg-gray-900/70 border border-gray-800/60 rounded-xl">
            <h2 className="text-lg font-semibold mb-3">Wallet & Blockchain</h2>
            <div className="space-y-2 text-sm">
              <p className="flex items-center gap-2">
                ...
                {walletInfo.address ? (
                  ...
                  <span className="px-2 py-0.5 text-xs rounded-full bg-gray-700/60 text-gray-300 border border-gray-600/60">
                    Not Connected
                  </span>
                )}
              </p>
